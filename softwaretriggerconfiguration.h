#ifndef SOFTWARETRIGGERCONFIGURATION_H
#define SOFTWARETRIGGERCONFIGURATION_H
...
namespace Pylon
{
    ...
    */
    ...
    // 	CSoftwareTriggerConfiguration is already defined in pylon/include, have to make your own name
    class   CSoftwareTriggerConfiguration1 : public CConfigurationEventHandler
    {
    public:
                   ...
                   if ( IsAvailable( pEntry))
                    {
                        ...
                        if ( triggerName == triggerNameOfEntry)
                       {
                            ...
                            //CEnumerationPtr(nodemap.GetNode("TriggerActivation"))->FromString("FallingEdge");
			    //CEnumerationPtr(nodemap.GetNode("TriggerActivation"))->FromString("AnyEdge");

                            CEnumerationPtr(nodemap.GetNode("ExposureMode"))->FromString("Timed"); 
                            CFloatPtr(nodemap.GetNode("ExposureTime"))->SetValue(1000.0);
...
#endif // SOFTWARETRIGGERCONFIGURATION_H
