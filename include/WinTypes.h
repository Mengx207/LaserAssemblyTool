...
typedef BYTE                    *LPBYTE;
typedef unsigned int            FT_BOOL;  // prefix FT to avoid duplicate with cypress
typedef unsigned char            BOOLEAN;
typedef unsigned char            FT_CHAR; // prefix FT to avoid duplicate with cypress 
typedef BOOL                    *LPBOOL;
...
#define INFINITE_FT232            0xFFFFFFFF  // Infinite timeout
